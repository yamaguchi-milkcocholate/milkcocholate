...
def macd():
    ...
    situation_dict['BUY-15MIN-PLUS-THRESHOLD'] = (0, 1)
    situation_dict['BUY-15MIN-MINUS-THRESHOLD'] = (-1, 0)
    situation_dict['BUY-5MIN-PLUS-THRESHOLD'] = (0, 1)
    situation_dict['BUY-5MIN-MINUS-THRESHOLD'] = (-1, 0)
    ...
    situation_dict['SELL-15MIN-PLUS-THRESHOLD'] = (0, 1)
    situation_dict['SELL-15MIN-MINUS-THRESHOLD'] = (-1, 0)
    situation_dict['SELL-5MIN-PLUS-THRESHOLD'] = (0, 1)
    situation_dict['SELL-5MIN-MINUS-THRESHOLD'] = (-1, 0)
