...
class FitnessFunction(ABC):
    ...
    def __init__(self, candle_type, db_dept, fitness_function_id, coin):
        if candle_type in self.BIT_BANK_CANDLE_STICK:
            self._candlestick = picker.Picker(candle_type, use_of_data='training', coin=coin).get_candlestick()
