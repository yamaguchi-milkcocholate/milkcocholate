...
gp = read_file(directory='15min/training/aggregate_gp_02.pkl')
buy_genome = gp.get_elite_genome()

fitness_function = TagNextFitnessFunction(ema_term=3, ma_term=6, goal=0.1, buy_genome=buy_genome, limit=50)
...
write_file(directory='15min/training/gp_next_03.pkl', obj=gp)
